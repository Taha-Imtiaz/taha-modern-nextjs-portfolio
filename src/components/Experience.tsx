        ...
        <section id="experience" className="py-20 bg-gray-950 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="relative">
                    {/* Timeline line */}
                    <div className="absolute left-2 md:left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-400 via-purple-400 to-pink-400"></div>
                    ...
                    <div className="space-y-16">
                        {experiences.map((exp, index) => (
                            ...
                            >
                                ...
                                <div className="absolute left-0 md:left-6 w-6 h-6 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full border-4 border-gray-900 shadow-lg">
